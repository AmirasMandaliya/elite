...
const musicIndiacardsData = [
    {
        title: "Peaceful piano",
        description: "Relax and indulge with beatiful piano pieces",
        imgUrl: "https://i.pinimg.com/564x/e3/b5/75/e3b575cb1d565557048003ea56bf86a2.jpg"
    },
    {
        title: "Peaceful piano",
        description: "Relax and indulge with beatiful piano pieces",
        ...
        <div className="h-full w-full flex">
            ...
            <div className="h-full w-4/5 bg-app-black overflow-auto">
                ...
                <div className="content p-8 pt-0 overflow-auto">
                    <PlaylistView
                        titleText="Explore Music"
                        cardsData={MusiccardsData}
                    />
                    <PlaylistView
                        titleText="Elite Playlists"
                        cardsData={playListcardsData}
                    />
                    <PlaylistView
                        titleText="Sound of India"
                        cardsData={musicIndiacardsData}
                    />
                </div>
            </div>
        </div>
